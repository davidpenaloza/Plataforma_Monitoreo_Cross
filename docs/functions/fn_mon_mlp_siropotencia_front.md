...
## Objetivo
Entregar señal front para MLP SIRO Potencia consumible por el dashboard cross vía var_mlp_siropotencia_front.
...
let source_data =
    ...
    // Ajustar filtro de dominio/componente para MLP SIRO Potencia - front
