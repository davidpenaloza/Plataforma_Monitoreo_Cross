...
## Objetivo
Entregar señal transformacion para MLP NaSH consumible por el dashboard cross vía var_mlp_transf_nash.
...
- Evaluar la señal más reciente por fuente/tabla relevante de MLP NaSH.
...
## Supuestos
1. Las señales de MLP NaSH están disponibles en el workspace `ams-uat-dataplatform-laws`.
...
let source_data =
    ...
    // Ajustar filtro de dominio/componente para MLP NaSH - transformacion
