...
## Objetivo
Entregar señal transformacion para MLP SIRO SAG consumible por el dashboard cross vía var_mlp_sirosag_transformacion.
...
- Evaluar la señal más reciente por fuente/tabla relevante de MLP SIRO SAG.
...
## Supuestos
1. Las señales de MLP SIRO SAG están disponibles en el workspace `ams-uat-dataplatform-laws`.
...
let source_data =
    ...
    // Ajustar filtro de dominio/componente para MLP SIRO SAG - transformacion
