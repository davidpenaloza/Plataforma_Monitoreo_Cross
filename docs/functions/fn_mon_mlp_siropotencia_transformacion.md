...
## Objetivo
Entregar señal transformacion para MLP SIRO Potencia consumible por el dashboard cross vía var_mlp_siroPotencia_transformacion.
...
- Evaluar la señal más reciente por fuente/tabla relevante de MLP SIRO Potencia.
...
## Supuestos
1. Las señales de MLP SIRO Potencia están disponibles en el workspace `ams-uat-dataplatform-laws`.
...
let source_data =
    ...
    // Ajustar filtro de dominio/componente para MLP SIRO Potencia - transformacion
