...
## Objetivo
Entregar señal prediccion para MLP NaSH consumible por el dashboard cross vía var_mlp_prediccion_nash.
...
let source_data =
    ...
    // Ajustar filtro de dominio/componente para MLP NaSH - prediccion
