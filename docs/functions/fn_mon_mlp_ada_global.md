...
## Objetivo
Estado global ADA combinando ingestas + procesamiento + front.
...
| extend status = iff(Dispatch=="ALERT" or PI=="ALERT" or Drillit=="ALERT" or Plans=="ALERT" or Blockgrade=="ALERT" or Meteo=="ALERT" or Settings=="ALERT" or KPIs=="ALERT" or Alarmas=="ALERT" or Front=="ALERT", "ALERT", "OK")
| extend color = case(status == "ALERT", "#E53935", "#EAF4EA")
| extend evidence = strcat("fn=fn_mon_mlp_ada_global; rule=iff(Dispatch=="ALERT" or PI=="ALERT" or Drillit=="ALERT" or Plans=="ALERT" or Blockgrade=="ALERT" or Meteo=="ALERT" or Settings=="ALERT" or KPIs=="ALERT" or Alarmas=="ALERT" or Front=="ALERT", "ALERT", "OK")")
