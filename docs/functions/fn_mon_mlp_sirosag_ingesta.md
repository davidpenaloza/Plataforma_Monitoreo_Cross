...
## Objetivo
Entregar señal ingestas para MLP SIRO SAG consumible por el dashboard cross vía var_mlp_sirosag_ingesta.
...
let source_data =
    ...
    // Ajustar filtro de dominio/componente para MLP SIRO SAG - ingestas
