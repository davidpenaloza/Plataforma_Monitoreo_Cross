...
## Objetivo
Entregar señal ingestas para MLP SIRO Potencia consumible por el dashboard cross vía var_mlp_siropotencia_ingesta.
...
let source_data =
    ...
    // Ajustar filtro de dominio/componente para MLP SIRO Potencia - ingestas
