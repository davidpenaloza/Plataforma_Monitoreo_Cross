...
## Objetivo
Entregar señal procesamiento para MLP ADA consumible por el dashboard cross vía var_mlp_ada_kpi.
...
## Tabla(s) probable(s)
ContainerAppConsoleLogs_CL, Logs_MLP_ADA_CL
...
let source_data =
    ...
    // Ajustar filtro de dominio/componente para MLP ADA - procesamiento
